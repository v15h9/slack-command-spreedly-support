...
Bot.prototype.botinit = function() {
  this.botuser = this.userbot.spawn({ token: 'xoxb-91776956356-t5qOsWHpNvCm59JZFfiwC81b' }).startRTM()

  this.botuser.hears('hi', ['ambient', 'direct_message','direct_mention','mention'],function(bot,message) {
